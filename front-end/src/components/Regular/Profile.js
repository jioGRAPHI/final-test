...
import ProfileReport from "./ProfileReport.js";
      ...
      <div>
          ...
          <div id="profile-background" className="profile-body">
            ...
            <div className="profile-body">
              <div className="profile-upperhalf">
                  <ReactImageFallback className="profile-restaurantimage" src={'/images/test.jpg'} fallbackImage={notfound} alt="Report to administrator for missing images" />
        ...
        <div id="profile-myModal" className="profile-modal">
          <div className="profile-modal-content">
            <ProfileReport setReportVisibilityToFalse={this.setReportVisibilityToFalse} user_id={this.state.user_id} restaurant_id={this.state.restaurant_id}/>
